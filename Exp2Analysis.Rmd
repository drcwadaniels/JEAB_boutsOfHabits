...
summary_mean$reCode_Condition[summary_mean$reCode_Condition=="0"] <-"NotPrefed"
summary_mean$reCode_Condition[summary_mean$reCode_Condition=="1"] <- "Prefed"
...
beta1_plot <- ggplot(mcmc_draws_long[which(grepl("betas",mcmc_draws_long$name) &
  ...
  ggtitle("Feeding Group Effect")+ 
  theme(axis.text.y=ggtext::element_markdown()) + 
  xlim(-4,4)

beta1_plot
ggsave(paste0(data.path,"Exp2.pdf"),dpi=1200)
...
meta_params_wminIRT$reCode_Condition[meta_params_wminIRT$reCode_Condition=="0"]<-"NotPrefed"
meta_params_wminIRT$reCode_Condition[meta_params_wminIRT$reCode_Condition=="1"]<-"Prefed"
